...
<section id="gallery" class="gallery">
        ...
        <h2 class="section-title">Photo Studio Gallery</h2>
        <div class="container">
        <div class="gallery-grid">
            <div class="gallery-item">
                <img src="resources/studiogallery1.jpeg" alt="Solo picture studio">
            </div>
            <div class="gallery-item">
            <img src="resources/studiogallery2.jpg" alt="Solo picture studio">
            </div>
            <div class="gallery-item">
            <img src="resources/studiogallery3.jpg" alt="Solo picture studio">
            </div>
            <div class="gallery-item">
            <img src="resources/studiogallery4.jpeg" alt="Solo picture studio">
            </div>
            <div class="gallery-item">
            <img src="resources/studiogallery5.jpeg" alt="Solo picture studio">
            </div>
            <div class="gallery-item">
            <img src="resources/studiogallery6.jpeg" alt="Solo picture studio">
            </div>
        </div>   
