...
<html lang="en">
    <head>
        ...
        <title>Events and Workshops Gallery</title>
...
<section id="gallery" class="gallery">
        ...
        <div class="gallery-grid">
            ...
            <img src="resources/20.jpg" alt="event photo">
            </div>
            <div class="gallery-item">
            <img src="resources/21.jpg" alt="event photo">
            </div>
            <div class="gallery-item">
            <img src="resources/22.jpg" alt="event photo">
            </div>
            <div class="gallery-item">
            <img src="resources/23.jpg" alt="event photo">
            </div>
            <div class="gallery-item">
            <img src="resources/24.jpg" alt="event photo">
            </div>
            <div class="gallery-item">
            <img src="resources/25.jpg" alt="event photo">
            </div>
        </div>   
