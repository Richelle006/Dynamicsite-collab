...
<body>
    ...
    <section id="home" class="main-section">
        <video id="mainVideo" controls autoplay loop muted>
            <source src="resources/main_video.mp4" type="video/mp4">
    ...
    <section id="contact">
        <div class="container contact-container">
            <div class="contact-info">
                <h2>Get in touch.</h2>
                <p>We offer multi-day discounts, event space, workshops, and customizable package bundles. Just drop us a message to get the conversation started.</p>
